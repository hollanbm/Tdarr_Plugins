...
const details = () => {
  return {
    id: "Tdarr_Plugin_hollanbm_FFMPEG_HQ_HEVC_MKV_Animation",
    Stage: "Pre-processing",
    Name: "FFMPEG HQ 10-bit HEVC MKV for Animation BRAD",
    Type: "Video",
    Operation: "Transcode",
...
const plugin = (file, librarySettings, inputs, otherArguments) => {
  ...
  {
    response.preset =
      ",-probesize 100M -analyzeduration 250M -map 0 -c:s copy -c:a copy -movflags use_metadata_tags -c:v:0 libx265 -preset medium -x265-params crf=18:tune=animation:qcomp=0.7:aq-strength=1.1 -pix_fmt yuv420p10le -f matroska";
    transcode = 1;
  }
